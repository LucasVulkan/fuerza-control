/**
 * FitLogo — las tres letras de "Fit" del logotipo, en `accent`.
 *
 * Estaba copiado literalmente en `AppHeader.jsx` y en `OnboardingScreen.jsx`;
 * con `SetupScreen` haciendo el tercer uso, vive aquí. Los paths salen del
