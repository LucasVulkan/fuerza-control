...
| [onboarding-simple.md](onboarding-simple.md) — Onboarding simple (2 preguntas) | **implementada** (ago 2026). Rehace la UI del modo `auto`; el motor no se toca | 🟢 | **Dos preguntas y tres portadas**: identidad → días → propuestas → preview. Nivel, tiempo, material y limitaciones dejan de preguntarse y pasan a ser **perillas encima del programa ya montado** — se tocan y los minutos cambian delante. Los programas se editan: un onboarding que intenta acertar a la primera paga ocho preguntas por una precisión que el editor da gratis. Añade la **tira de semana**, que dibuja el ciclo rotativo en vez de explicarlo. Sólo móvil |
